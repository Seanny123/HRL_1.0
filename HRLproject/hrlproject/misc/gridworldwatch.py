...
class GridWorldWatch(WatchTemplate):
    """Watch for the GridWorldEnvironment (for use in interactivemode display)."""
    ...
    def display_Qs(self, obj):
        ...
        Idea is to colour each cell according to the identity of the action with
        the highest Q value at that point.
        """

        # note: this function assumes that there are four actions (generally, representing
