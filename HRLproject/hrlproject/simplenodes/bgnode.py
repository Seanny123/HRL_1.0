...
class BGNode(nef.SimpleNode):
    ...
    def tick(self):
        ...
        # have to put this in here (rather than in termination) 
        # to be sure it is executed 
    ...
    def origin_curr_vals(self):
        return [1.0 if i == self.vals.index(max(self.vals)) else 0.0 for i in range(self.d)]
